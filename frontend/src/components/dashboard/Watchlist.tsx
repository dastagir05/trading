...
const Watchlist = ({ watchlistName }: WatchlistProps) => {
  ...
  const handleDeleteStock = async (instrumentKey: string) => {
    ...
    setWatchlist((prev) => prev?.filter((stock) => stock.instrument_key !== instrumentKey)); // this look not good but i will work
  };
              ...
              {watchlist?.map((stock, index) => (
                ...
                >
                  ...
                  <div className="text-right flex">
                    ...
                    {isEdit && (
                      <button onClick={() => handleDeleteStock(stock.instrument_key)}>
