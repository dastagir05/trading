  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{adminStats.totalTrades.toLocaleString()}</p>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">₹{(adminStats.totalVolume / 10000000).toFixed(1)}Cr</p>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">₹{(adminStats.revenue / 100000).toFixed(1)}L</p>
              ...
              <div className="bg-white rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-green-600">{adminStats.serverUptime}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-medium text-yellow-600">{adminStats.pendingKYC}</span>
                  </div>
                </div>
              </div>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {recentUsers.map((user) => (
                      <tr key={user.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="text-sm text-gray-900">{user.totalTrades} trades</div>
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${getStatusColor(user.tradingStatus)}`}>
                            {user.tradingStatus}
                          </span>
                        </td>
        ...
        {activeTab === 'trades' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Trade Management</h3>
            <p className="text-gray-600">Trade monitoring and management tools will be displayed here.</p>
          </div>
        )}
        ...
        {activeTab === 'analytics' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600">Advanced analytics and reporting tools will be displayed here.</p>
          </div>
        )}
        ...
        {activeTab === 'system' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600">System monitoring and configuration tools will be displayed here.</p>
          </div>
        )}
        ...
        {activeTab === 'settings' && (
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <p className="text-gray-600">Administrative settings and configurations will be displayed here.</p>
          </div>
        )}
      </div>
    </div>
